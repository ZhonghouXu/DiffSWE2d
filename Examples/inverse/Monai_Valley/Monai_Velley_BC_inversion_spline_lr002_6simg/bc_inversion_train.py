...
GAUGE_COLUMNS = {"gauge_0": 1, "gauge_1": 2, "gauge_2": 3,"gauge_3": 4,"gauge_4": 5,"gauge_5": 6}
GAUGE_FILE_SKIP_ROWS = 1
OBSERVATION_TYPE = "water_level"

# Two gauges train the inversion; the held-out gauge is reported only.
TRAIN_GAUGES = ("gauge_0", "gauge_1", "gauge_3", "gauge_4", "gauge_5")
TEST_GAUGES = ("gauge_2",)
