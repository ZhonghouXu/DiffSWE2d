...
rain_filepath = "cstRain-test3.txt" # Choose None if no rain
...
bnd_right = "wall"
bnd_top = "wall"
bnd_bottom = "transmissive"  # Use "absorbing" to allow outflow without reflection
